...
public class CollectFlintTask extends ResourceTask {
    ...
    protected Task onResourceTick(AltoClef mod) {
        ...
        Optional<BlockPos> closest = mod.getBlockScanner().getNearestBlock(mod.getPlayer().position(), validGravel -> WorldHelper.fallingBlockSafeToBreak(validGravel) && WorldHelper.canBreak(validGravel), Blocks.GRAVEL);
