...
public class CollectHoneycombTask extends ResourceTask {
    ...
    protected Task onResourceTick(AltoClef mod) {
        ...
        if (campfire && !isCampfireUnderNest(mod, nest)) {
            ...
            return new PlaceBlockTask(nest.below(2), Blocks.CAMPFIRE);
        }
        ...
        if (mod.getWorld().getBlockState(nest).getValue(BlockStateProperties.LEVEL_HONEY) != 5) {
            if (!nest.closerToCenterThan(mod.getPlayer().position(), 20)) {
