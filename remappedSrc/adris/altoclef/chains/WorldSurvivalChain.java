...
public class WorldSurvivalChain extends SingleTaskChain {
    ...
    public float getPriority() {
        ...
        if (mod.getModSettings().shouldExtinguishSelfWithWater()) {
            if (!(mainTask instanceof EscapeFromLavaTask && isCurrentlyRunning(mod)) && mod.getPlayer().isOnFire() && !mod.getPlayer().hasEffect(MobEffects.FIRE_RESISTANCE) && !mod.getWorld().dimensionType().ultraWarm()) {
